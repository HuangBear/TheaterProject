...
public class BulletinController {
	...
	@RequestMapping(value = "/allBulletin/{bulletin_no}")
	public String allBulletin2newBulletin(@PathVariable("bulletin_no") Integer no, Model model) {
		BulletinBean bb = service.getBulletinBeanById(no);
		model.addAttribute("editBulletin", bb);
		return "newBulletin";
	}
	...
	public String post_newBulletin2allBulletin(@ModelAttribute("getNewBulletin") BulletinBean bb,
