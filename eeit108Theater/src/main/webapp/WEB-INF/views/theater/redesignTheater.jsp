...
<div class="card mb-3">
	<div class="card-header">
		<div class="row">
			<div class="col-2">
				<i class="fas fa-table"></i> 7-1 Cinema Redesign ${theater}
			</div>
		</div>
		<div class="row mt-2">
			<div class="col">
...
<script type="text/javascript">
	$(function() {
		...
		$("input.emptySeat").filter("[name='seat']").prop("checked", true).change();
		...
		$("#modifyForm").submit(function(event){
			...
			$.ajax({
				...
				processData : false,
				success : function(data) {
					console.log("redesign theater confirm success");
					$("#pageItems").html(data);
				},
				error : function() {
					console.log("fail to confirm redesign theater");
				}
			});
		});
	});
