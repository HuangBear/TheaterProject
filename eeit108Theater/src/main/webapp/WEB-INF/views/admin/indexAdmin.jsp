...
<!--  					<iframe  id="youtube" class="embed-responsive-item" width="800" height="600" src="https://www.youtube.com/watch?v=Eoook2Ee6q0"></iframe> -->
	...
	<div>
		<ul class="nav nav-pills w3-centered " style="display: flex;font-size:13px;justify-content: center; position: static">
		  <li role="presentation"><a href="<%=request.getContextPath()%>">關於我們</a></li>
		  <li role="presentation"><a href="<%=request.getContextPath()%>">免責聲明</a></li>
		  <li role="presentation"><a href="<%=request.getContextPath()%>">服務條款</a></li>
		  <li role="presentation"><a href="<%=request.getContextPath()%>">隱私權聲明</a></li>
		</ul>
	</div>
