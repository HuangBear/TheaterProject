			...
			<form:form method="POST" action="emp_add" modelAttribute="employeeBean">
				...
				<div class="form-group">
					<div class="form-label-group">
						<form:input type="email" id="email" class="form-control" placeholder="email" required="required" autofocus="autofocus" path="email" />
				...
				<div class="form-group">
					<div class="form-label-group">
						<form:input type="text" id="employeeId" class="form-control" placeholder="employeeId" required="required" path="employeeId" />
						<label for="employeeId">員工身分證號碼</label>
					</div>
				</div>
				<div class="form-group">
					<div class="form-label-group">
						<form:input type="text" id="name" class="form-control" placeholder="name" required="required" path="name" />
						<label for="name">員工姓名</label>
					</div>
				</div>
				<div class="form-group">
					<div class="form-label-group">
						<form:input type="text" id="phoneNum" class="form-control" placeholder="phoneNum" required="required" path="phoneNum" />
				...
				<div class="form-group">
					<div class="form-label-group">
						<form:input type="password" id="password" class="form-control" placeholder="password" required="required" path="password" />
				...
				<div class="form-group">
					<div class="form-label-group">
						<form:select id="gender" class="form-control" required="required" path="gender">
				...
				<div class="form-group">
					<div class="form-label-group">
						<form:input type="date" id="birthdayString" class="form-control" required="required" path="birthdayString" />
				...
				<div class="form-group">
					<div class="form-label-group">
						<form:input type="text" id="salary" class="form-control" placeholder="salary" required="required" path="salary" />
