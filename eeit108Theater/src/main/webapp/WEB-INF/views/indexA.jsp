        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
			...
			<tr>
				...
				<td>
				<button class="btn btn-info"  onclick="javascrtpt:window.location.href='admin/emp_update?pk=${emp.no}'">
				編輯員工資料
				</button><p>
				</td>
				<td>
				<button class="btn btn-danger"  onclick="javascrtpt:window.location.href='admin/EmpResign?pk=${emp.no}'">
				設定離職
				</button><p>
				</td>
			</tr>
