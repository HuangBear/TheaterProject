...
<body class="homepage is-preload">
								...
								<form action="#">
									<fieldset>
										...
										<select name="請選擇查詢日期" id="files" class = 'hello'>
											<option value="default">請選擇查詢日期</option>
											<option>${day1}</option>
											<option>${day2}</option>
											<option>${day3}</option>
											<option>${day4}</option>
									...
									<center>
										<a id='ticketing'
											href="<c:url value='/order/showProducts?time=${StartTime.no}'/>"><button
												type='button' id='submit'>前往訂票</button></a>
	...
	<script>
		$(document).ready(function() {      
			...
			$("#salutation").change(function() {	 <!-- 時刻變更 --> 
				var selectedMovie = $("#speed option:selected").text();
				var selectedVersion = $("#number option:selected").text();
				var selectedDate = $("#files option:selected").text();
