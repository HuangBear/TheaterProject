						...
						<c:choose>
							<c:when test='${nihao.count % 5 == 1}'>
								<tr>
									<td>
										．
										<a href='ticketing_${releasedMovie.no}' class='hello'>${releasedMovie.movieName}</a>
									</td>
							</c:when>
				...
				<div class="row gtr-200">
					<div class="col-4 col-12-mobile" id="sidebar">
						<section>
							...
							<p>
								上映日期：
								<fmt:formatDate value="${movie.openingDate}" pattern='yyyy-MM-dd' />
							</p>
											...
											<c:when test='${!empty todayStartTimes_2D}'>
												...
												<dt>
													<c:forEach var='StartTime' items='${todayStartTimes_2D}'>
														<dd class='dtdd foo'>
															<a href='<c:url value="/order/showProducts?time=${StartTime.no}"/>'>${StartTime.startTime}</a>
														</dd>
													</c:forEach>
												</dt>
												<br>
			...
			<div style="width: 1280px; margin: auto;">
				<section>
					...
					<p>
						...
						4.未滿２歲且不佔位之兒童無需購票可免費入場觀賞【普遍級】影片，每位兒童需由至少一位已購票之成人陪伴。<br> 5.需佔位或２歲以上未滿１２歲之兒童；需購買優待票。<br>
						6.購票完成可至超商進行取票，若交易內含餐飲品項，須至購票影城臨櫃領取電影票與餐點。<br> 7.網路訂票每張票需加收 NT$20 手續費。<br> 8.片長
						150分鐘(含)以上之電影需加價NT$10，每增加30分鐘需另再加價NT$10。
					</p>
				</section>
				<section>
					<header>
					...
					<p>
						1.週五上映之電影，新場次公布於每週三中午12:00~下午18:00，開放未來一週(即當週的星期五至下週星期四為止)之場次。<br> 2.週三上映之電影，新場次公布於每週一晚上20:00~22:00，開放週三、週四之場次。<br>
						3.週四上映之電影，新場次公布於每週二晚上20:00~22:00，開放週四之場次。<br> 4.其他因預售活動或特殊假期、特殊開片日之電影，將另行公告場次開放時間。
					</p>
				</section>
			</div>
		</center>
